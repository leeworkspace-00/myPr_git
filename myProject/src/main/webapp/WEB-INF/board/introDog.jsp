...
<body>
  ...
  <div class="feature">
    <img src="../resources/images/outdoor_dog.jpg" alt="강아지 산책 이미지">
    <div class="text">
      <h2>즐겁고 안전한 산책시간</h2>
  ...
  <div class="feature">
    <img src="../resources/images/cleandog.jpg" alt="배변처리 이미지">
    <div class="text">
  ...
  <div class="feature">
    <img src="../resources/images/indoor_dog.jpg" alt="실내 놀이 이미지">
    <div class="text">
  ...
  <div class="feature">
    <img src="../resources/images/dog_eat.jpg" alt="강아지 식사 이미지">
    <div class="text">
      <h2>혼자서도 잘 챙겨 먹어요</h2>
