...
<script>
	function check()  {
		...
		if(fm.subject.value=="") {
			...
			if(ans==true) {
				fm.action="<%=request.getContextPath()%>/board/askWriteAction.aws";
				fm.method="post";
...
<form name = "frm">
<input type="text" id="boardkind" name="boardkind" value="A">
<table class = "writeTable">
<tr>
	<th>제목</th> <!-- 테이블 헤드 표 첫줄들어가는 자리 -->
	<td><input type="text" name="subject" value ="문의합니다~"></td>
</tr>
<tr>
