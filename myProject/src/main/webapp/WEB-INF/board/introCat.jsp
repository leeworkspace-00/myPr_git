...
<body>
  ...
  <div class="feature">
    <img src="../images/cat1.jpg" alt="강아지 산책 이미지">
    <div class="text">
      <h2>엄선된 집사가 돌봐드려요</h2>
  ...
  <div class="feature">
    <img src="../images/catcare.jpg" alt="배변처리 이미지">
    <div class="text">
  ...
  <div class="feature">
    <img src="../images/catplay.jpg" alt="실내 놀이 이미지">
    <div class="text">
  ...
  <div class="feature">
    <img src="../images/cateat.jpg" alt="강아지 식사 이미지">
    <div class="text">
      <h2>혼자서도 잘 챙겨 먹어요</h2>
