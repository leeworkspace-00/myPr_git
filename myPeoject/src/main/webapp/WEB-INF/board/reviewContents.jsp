	...
	<article class="detailContents">
		...
		<div class="content">
			...
			<table>
				...
				<tr>
					<th>첨부파일</th>
					<td>	<% if (bv.getFilename() == null || bv.getFilename().equals("") ) {}else{ %>	
...
<%-- 		
 ...
 --%>
	...
	<div class="btnBox">
		<a class="btn aBtn"
			href="<%=request.getContextPath()%>/board/reservationAccept.aws?bidx=<%=bv.getBidx()%>">승인</a>
		<a class="btn aBtn"
			href="<%=request.getContextPath()%>/board/boardDelete.aws?bidx=<%=bv.getBidx()%>">거절</a>
		<a class="btn aBtn"
			href="<%=request.getContextPath()%>/board/reservationList.aws">목록</a>
	</div>
